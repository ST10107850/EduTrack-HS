...
const About = () => {
  return (
    <div className="w-full mt-20  rounded-3xl flex flex-col items-center bg-gray-400 py-12 px-20">
      {/* Main Title and Description */}
      <div className="text-left mb-16 w-full">
        <h1 className="text-8xl font-bold mb-4">Enjoy Studying at Johannesburg Secondary School</h1>
